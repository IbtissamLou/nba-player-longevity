...
def score_classifier_with_tuning(dataset, classifier, labels, param_grid, cv=5, kfold_type="kfold"):
    """
    Evaluates a classifier using cross-validation and hyperparameter tuning.

    :param dataset: Feature dataset
    :param classifier: Classifier to evaluate
    :param labels: Corresponding labels
    :param param_grid: Grid of hyperparameters for `GridSearchCV`
    :param cv: Number of folds for cross-validation (default = 5)
    :param kfold_type: Type of cross-validation ('kfold' or 'stratified')
    :return: None
    """
